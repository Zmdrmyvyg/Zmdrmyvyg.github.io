...
.selected-work-home .work-figure { display: block; margin-top: .85rem; border: 1px solid var(--global-divider-color); border-radius: 0; overflow: hidden; background: #fff; cursor: zoom-in; }
